...
const popularGames = `games?key=${API_KEY}&dates=${lastYear},${todaysDate}&ordering=-rating&page_size=50`;
...
export const gameSearchURL = (searchQuery) => `${baseUrl}games?key=${API_KEY}&search=${searchQuery}&page_size=16`;